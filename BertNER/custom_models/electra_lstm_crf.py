...
class ElectraLstmCrf(ElectraPreTrainedModel):
    def __init__(self, config, extra_config, ignore_ids):
        ...
        """
        super(ElectraLstmCrf, self).__init__(config)
        self.pretrained = ElectraModel(config)
    ...
    def forward(self,
        ...
        discriminator_hidden_states = self.pretrained(
