...
def is_transition_allowed(
    ...
    if constraint_type == "BIOUL":
    ...
    elif constraint_type == "BIOES": # same as "BIOUL"
        if from_tag == "START":
        ...
        return any(
            [
                ...
                # E-x can transition to O, B-*, or S-*
                # S-x can transition to O, B-*, or S-*
